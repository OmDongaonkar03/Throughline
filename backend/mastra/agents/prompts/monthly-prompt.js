...
/**
 * Create monthly generator agent with tone profile
 * @param {Object} completeToneProfile - Complete tone profile
 * @returns {Agent} Configured agent
 */
export function createMonthlyGeneratorAgent(completeToneProfile) {
...
5. NARRATIVE FLOW
   - Create smooth transitions between weeks
   - Build a coherent story arc across the month
   - Show progression naturally, not mechanically
   - Let the narrative reveal itself organically
